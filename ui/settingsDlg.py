...
class SourcesListCtrl(wx.ListCtrl, listmix.CheckListCtrlMixin):
    ''' This is a mixin for ListCtrl which add a checkbox in the first column of each row. '''
...
class SettingsDlg(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_CHECKBOX, self.OnClicked, self.checkbox_2)
        ...
        # end wxGlade
        self.sources_list_ctrl_1.OnCheckItem = self.on_check_item
    ...
    def save_settings(self):
        ...
        # Sources
        self.myConfig.source_windows_spotlight = self.sources_list_ctrl_1.IsChecked(0)
        self.myConfig.source_flickr_peter_levi = self.sources_list_ctrl_1.IsChecked(2)
        self.myConfig.source_bing = self.sources_list_ctrl_1.IsChecked(1)
        self.myConfig.source_wikimedia = self.sources_list_ctrl_1.IsChecked(3)
    ...
    def set_settings(self):
        ...
        if self.myConfig.source_windows_spotlight:
            self.sources_list_ctrl_1.CheckItem(0, check=True)

        if self.myConfig.source_bing:
            self.sources_list_ctrl_1.CheckItem(1, check=True)

        if self.myConfig.source_flickr_peter_levi:
            self.sources_list_ctrl_1.CheckItem(2, check=True)

        if self.myConfig.source_wikimedia:
    ...
    def __set_properties(self):
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("data/logo_1_32x32px.ico", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)
    ...
    def __do_layout(self):
        ...
        label_5 = wx.StaticText(self.notebook_1_General, wx.ID_ANY, _("General"))
        ...
        label_6 = wx.StaticText(self.notebook_1_General, wx.ID_ANY, _("Minutes"))
        ...
        label_7 = wx.StaticText(self.notebook_1_General, wx.ID_ANY, _("Minutes into the folder"))
        sizer_7.Add(label_7, 0, wx.ALL, 10)
        sizer_7.Add(self.dirpickerctrl_1, 1, wx.ALL | wx.EXPAND, 0)
        sizer_2.Add(sizer_7, 1, wx.ALIGN_CENTER | wx.EXPAND, 0)
        sizer_8.Add(self.checkbox_10, 0, wx.ALL, 10)
        sizer_8.Add(self.combo_box_6, 0, wx.ALL, 6)
        label_8 = wx.StaticText(self.notebook_1_General, wx.ID_ANY, _("MB (older files are deleted if necessary)"))
        ...
        label_2 = wx.StaticText(self.notebook_1_Sync, wx.ID_ANY, _("VRTY.ORG is currently not publically available"))
        sizer_10.Add(label_2, 0, wx.ALIGN_CENTER | wx.ALL, 10)
        self.notebook_1_Sync.SetSizer(sizer_10)
        label_3 = wx.StaticText(self.notebook_1_Fetch, wx.ID_ANY, _("Fetch folder"))
    ...
    def OnButtonClose(self, event):  # wxGlade: SettingsDlg.<event_handler>
        self.myConfig.set_config()
        self.myConfig.__del__(self)
        self.Destroy()
