...
class SettingsDlg(wx.Frame):
    ...
    def __do_layout(self):
        ...
        label_20 = wx.StaticText(self.notebook_1_Info, wx.ID_ANY, _("Release Information"))
        label_20.SetFont(wx.Font(9, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        grid_sizer_1.Add(label_20, 0, wx.ALL, 10)
        label_21 = wx.StaticText(self.notebook_1_Info, wx.ID_ANY, _("<release info string>"))
        grid_sizer_1.Add(label_21, 0, wx.ALL, 10)
    ...
    def show_version_str(self, event, msg):
        #self.label_19.SetLabel(msg)
        self.sizer_19.Add(self.label_19, 0, wx.ALL, 10)
