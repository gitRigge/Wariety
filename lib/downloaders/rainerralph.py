...
START_URL = 'https://www.flickr.com/photos/rainerralph/'
BASE_URL = 'https://www.flickr.com/photos/rainerralph/'
DOWNLOADER_TYPE = 'rainerralph'
DOWNLOADER_DESCRIPTION = 'Rainer Ralph\'s Flickr Collection'
CAPABILITIES = {'single': 'single', 'many': 'many'}

API_KEY = u'2861cd9d551ee36dc08123f5c7c04ff6'
USER_ID = '96027338@N08'


class RainerRalphDownloader(DefaultDownloader):
    ...
    def get_next_image(self, last_image_counter=0):
        """Retrieves the URL of the latest image of Rainer Ralph's Flickr Collection,
        ...
        if self.state['stat'] == 'ok':
            ...
            if image_info_data['stat'] == 'ok':
                ...
                if image_sizes['stat'] == 'ok':
                    ...
                    next_image.image_author = 'Rainer Ralph'
