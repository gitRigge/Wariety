...
START_URL = 'https://www.flickr.com/photos/184981954@N06/'
BASE_URL = 'https://www.flickr.com/photos/184981954@N06/'
DOWNLOADER_TYPE = 'holdinghausenm'
DOWNLOADER_DESCRIPTION = 'Michael Holdinghausen\'s Flickr Collection'
CAPABILITIES = {'single': 'single', 'many': 'many'}

API_KEY = u'2861cd9d551ee36dc08123f5c7c04ff6'
USER_ID = '184981954@N06'


class MichaelHoldinghausenDownloader(DefaultDownloader):
    ...
    def get_next_image(self, last_image_counter=0):
        """Retrieves the URL of the latest image of Michael Holdinghausen's Flickr Collection,
        ...
        if self.state['stat'] == 'ok':
            ...
            if image_info_data['stat'] == 'ok':
                ...
                if image_sizes['stat'] == 'ok':
                    ...
                    next_image.image_author = 'Michael Holdinghausen'
